...
/**
 * Lucide-style 24×24 stroke icons, inlined so the design system has no
 * runtime CDN dependency. Stroke weight 2, round caps/joins — matches the
 * Lucide set (https://lucide.dev). Add new glyphs to PATHS as needed.
 */
const PATHS = {
  // Navigation / modules
